...
if !has("python3")
    echo "image.vim requires python 3.x support"
    finish
endif

" TODO: for some reason even though the filetype is set, when opening a .jpg, it isn't set
au FileType image :call DisplayImage()
